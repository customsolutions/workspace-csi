...
cprequire_test(["inline:com-chilipeppr-workspace-csi"], function(ws) {
...
cpdefine("inline:com-chilipeppr-workspace-csi", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-csi", // Make the id the same as the cpdefine id
