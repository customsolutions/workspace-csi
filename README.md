...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-csi |
| Name                  | Workspace / grbl |
...
| Test URL              | https://vfs.cloud9.us-east-2.amazonaws.com/vfs/b8a7cb3877d54044873863445dd756e0/preview/workspace-csi/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "https://raw.githubusercontent.com/customsolutions/workspace-csi/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-csi"], // the id you gave your workspace
      function(myWorkspaceCsi) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / grbl just got loaded.", myWorkspaceCsi);
        myWorkspaceCsi.init();
      }
    );
  }
